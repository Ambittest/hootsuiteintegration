...
var secret = 'hootsuitezaintest';

//--- Client for hydrating twitter data - ADD YOUR OWN CREDENTIALS --- 
//--- Otherwise, app will not show up in plugin list --- 
try {
  var twitterClient = new Twitter({
    consumer_key: 'dhdhdjdjdfkdfhkhk',
    consumer_secret: 'kghkfhkfhkfhkfkdfk',
    access_token: 'ncmmcvmcc,c,cb,',
    access_token_secret: 'djsdgjgtjrtjurtrtu'
  });
} catch(error) {

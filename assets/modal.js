...
function populateMessage(data) {
  ...
  //my custom code
  var network = data.post.network;
  var userid = data.post.user.userid;
  var username = data.post.username;
...
function startEventListeners() {
	/* my custom code */
	 getSingleElementByClassName('hs_sendCase').addEventListener('click', function () {
        var network_ = document.getElementById('network').value;
		 var userid = document.getElementById('userid').value;
		  var username = document.getElementById('username').value;
		   var case_number = document.getElementById('case_number').value;
		   app.get('https://192.168.100.154/SampleApp2/SampleApp2/my_plugin.html', function(req, res) {
			var data = {
				"fruit": {
